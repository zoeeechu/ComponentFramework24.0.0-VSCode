...
bool Scene0g::OnCreate() {
	...
	mesh = new Mesh("./ComponentFramework/meshes/Sphere.obj");
	mesh->OnCreate();

	shader = new Shader("./ComponentFramework/shaders/defaultVert.glsl", "./ComponentFramework/shaders/defaultFrag.glsl");
